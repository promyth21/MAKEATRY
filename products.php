        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class='card-body container text-center'>
                    ...
                    <a class='btn bg-success' href='editProduct.php? productID=$row[id]'>Edit Product</a>
                    <a class='btn bg-danger' href='deleteProduct.php? productID=$row[id]'>Delete Product</a> 
